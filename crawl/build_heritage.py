...
TIER = {
    ...
    "geopark":            {"point": 1, "color": "#c1440e", "label": "世界ジオパーク",  "order": 4},
}
...
# ============================================================
# ユネスコ世界ジオパーク (Global Geopark) 11地域
# 範囲が広いため、各ジオパーク内の代表的な観光名所1件を1スポットとしてピン立てする
# ============================================================
GEOPARKS = [
    # geopark_name, spot_name, [prefectures], lat, lon, note
    ("洞爺湖有珠山ユネスコ世界ジオパーク", "昭和新山", ["北海道"], 42.5440, 140.8346, "2015年認定"),
    ("アポイ岳ユネスコ世界ジオパーク", "アポイ岳", ["北海道"], 42.1075, 143.0847, "2015年認定"),
    ("糸魚川ユネスコ世界ジオパーク", "フォッサマグナパーク", ["新潟県"], 36.9576, 137.8565, "2015年認定"),
    ("山陰海岸ユネスコ世界ジオパーク", "鳥取砂丘", ["鳥取県"], 35.5389, 134.2258, "2015年認定（ジオパーク自体は京都府・兵庫県・鳥取県にまたがる）"),
    ("室戸ユネスコ世界ジオパーク", "室戸岬", ["高知県"], 33.2508, 134.1757, "2015年認定"),
    ("隠岐ユネスコ世界ジオパーク", "摩天崖", ["島根県"], 36.2986, 133.0669, "2015年認定"),
    ("阿蘇ユネスコ世界ジオパーク", "阿蘇中岳火口", ["熊本県"], 32.8847, 131.1043, "2015年認定"),
    ("島原半島ユネスコ世界ジオパーク", "平成新山（雲仙普賢岳）", ["長崎県"], 32.7614, 130.2989, "2015年認定"),
    ("伊豆半島ユネスコ世界ジオパーク", "城ヶ崎海岸", ["静岡県"], 34.8958, 139.1319, "2018年認定"),
    ("白山手取川ユネスコ世界ジオパーク", "手取峡谷", ["石川県"], 36.3006, 136.6494, "2023年認定"),
    ("Mine秋吉台ユネスコ世界ジオパーク", "秋芳洞", ["山口県"], 34.2334, 131.3036, "2026年認定"),
]
...
def main():
    ...
    # ユネスコ世界ジオパーク（範囲が広いため代表スポット1件をピン立て）
    for geo_name, spot_name, prefs, lat, lon, note in GEOPARKS:
        e = entry(spot_name, prefs, "ジオパーク", "geopark", lat, lon, note,
                  sub=geo_name, wh_site="")
        items.append(e)
