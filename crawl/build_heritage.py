...
"""
世界遺産マップ用データビルダ。
- 世界遺産(26) / 暫定リスト記載候補(27) / 公式暫定リスト(1) は座標付きシード
...
TENTATIVE_OFFICIAL = [
    ...
    ("飛鳥・藤原の宮都とその関連資産群", ["奈良県"], "文化遺産", 34.4772, 135.8180, "明日香村（2026年登録審査予定）"),
]
